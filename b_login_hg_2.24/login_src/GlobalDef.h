...
#define MSG_WORLDNAME1			"¾Ô³õ»â°ì" // Long name for 1st server...
#define MSG_HOMEPAGE			"http://hk.geocities.com/editor1989/"
#define DEF_UPPERVERSION		3
#define DEF_LOWERVERSION		82
#define DEF_SERVER_IP			"192.168.1.100"
